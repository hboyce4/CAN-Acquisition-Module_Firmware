...
#define SCD30_CMD_READ_MEAS 0x0300 /* begin continuous measurement */
...
typedef struct digital_sensor_channel{ /* Process values or state variables */
	...
	uint16_t temperature_fieldValue;/* [cnt] Raw value from the converter */
	...
	uint16_t humidity_fieldValue;/* [cnt] Raw value from the converter */
	...
	uint16_t CO2_fieldValue;/* [cnt] Raw value from the converter */
